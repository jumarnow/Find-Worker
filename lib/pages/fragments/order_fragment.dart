...
import 'package:myapp/controllers/fragments/order_controller.dart';
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              orderController.setCompleted(context, booking.$id,
                  booking.workerId, userController.data.$id!);
            },
            child: Container(
